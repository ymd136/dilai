      ...
      <div className="container">
        <div className={styles.footerTop}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.brandDesc}>
              Yapay zeka destekli dil eğitimi platformu. Eğitim kurumları,
              öğrenciler ve eğitmenler için tasarlandı.
            </p>
            {/* Social Icons */}
        ...
        <div className={styles.footerBottom}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} DilAI. Tüm hakları saklıdır.
          </p>
          <p className={styles.madeWith}>
            Takım 107 tarafından ❤️ ile geliştirilmiştir.
          </p>
        </div>
      </div>
    </footer>
